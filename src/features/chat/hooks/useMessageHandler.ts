...
setIsLoading(true);
try {
  // Enhanced image request detection with logging
  ...
  console.log('Lowercase message:', userMessage.toLowerCase());
  // Save user message
  ...
  // Debug log for image request path
  if (isImageRequest) {
    console.log('Entering image generation path');
    ...
    console.log('Entering text response path');
