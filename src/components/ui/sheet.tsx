...
=======
  "fixed z-50 gap-4 p-6 bg-transparent transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
>>>>>>> 9e4bdd2397f6970cf39129b68f41b0bf7e10c9cb
  {
    variants: {
      side: {
