...
// Main AuthModal component that handles the authentication UI
    ...
    <Dialog open={isOpen} modal>
      <DialogContent className="sm:max-w-[425px] bg-white text-black p-6">
        <div className="space-y-6">
          ...
          {/* Main authentication form with integrated toggle */}
          <AuthForm 
            isLogin={isLogin} 
...
export const AuthForm = ({ isLogin, onToggle, redirectURL }: AuthFormProps) => (
  <div className="space-y-6">
    ...
    <Auth
      ...
      showLinks={false} // Disabled built-in links to prevent duplicate toggle
      localization={{
        variables: {
          sign_in: {
            email_label: "Email",
    ...
    {/* Custom toggle between login and signup */}
...
export const AuthFooter = () => (
  <div className="text-center text-xs text-gray-500 mt-6">
    <div className="flex flex-col items-center justify-center space-y-2">
      ...
      >
        <img 
          src="/lovable-uploads/supabaselogo.png" // Updated to use local image
          alt="Supabase" 
          className="h-6"
        />
      </a>
